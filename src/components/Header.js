...
const Header = () => {
  ...
  return (
    ...
    <div className="container">
        ...
        <NavLink to="/"><img id="logotype" src={Logo} alt="crito-logotype"/></NavLink>
        <button className={btnClasses} opnClick={toggleMenu}><i className="fa-solid fa-bars-staggered"></i></button>
